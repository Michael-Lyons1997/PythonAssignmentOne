...
def displaySub1():
    return render_template("computingTechnologiesSubpageOne.html", title="CV Page", heading="This is my CV",)

@app.get("/showTechSubpage2")
def displaySub2():
    return render_template("computingTechnologiesSubpageTwo.html", title="CV Page", heading="This is my CV",)

@app.get("/showTechSubpage3")
def displaySub3():
    return render_template("computingTechnologiesSubpageThree.html", title="CV Page", heading="This is my CV",)
